...
use contract_interface::{NrhvFlow, SubmissionNode, SubmitFilter};
...
impl LogEntryFetcher {
    ...
    pub fn start_recover(
        ...
        let contract = NrhvFlow::new(self.contract_address, provider.clone());
    ...
    pub fn start_watch(
        ...
        let contract = NrhvFlow::new(self.contract_address, self.provider.clone());
        let provider = self.provider.clone();
